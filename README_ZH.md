...
- **统一 MCP, SKILLS 管理** — 一个面板管理 Claude / Codex / Gemini / OpenCode 的 MCP、Skills，并额外支持内部 `codefree-o` CLI 的 MCP 同步
...
- **统一 MCP 面板** — 管理 Claude / Codex / Gemini / OpenCode 的 MCP 服务器，双向同步，支持 Deep Link 导入，并可额外同步到内部 `codefree-o` CLI
