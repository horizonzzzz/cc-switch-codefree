...
> = {
  ...
  "codefree-o": { key: "codefree-o", defaultFolder: ".codefree-o/.config" },
    ...
    const load = async () => {
      try {
        const [
          ...
          settingsApi.getConfigDir("codefree-o"),
          ...
          computeDefaultConfigDir("codefree-o"),
        ...
        defaultsRef.current = {
          ...
          "codefree-o": defaultCodefreeODir ?? "",
        ...
        setResolvedDirs({
          ...
          "codefree-o": codefreeODir || defaultsRef.current["codefree-o"],
  ...
  const resetAllDirectories = useCallback(
    (overrides?: ResolvedAppDirectoryOverrides) => {
      ...
      setResolvedDirs({
        ...
        "codefree-o":
          overrides?.["codefree-o"] ?? defaultsRef.current["codefree-o"],
